    ...
    def box_label(self, box, label: str = "", color: tuple = (128, 128, 128), txt_color: tuple = (255, 255, 255)):
        ...
        if self.pil:
            ...
            if label:
                ...
                if p1[0] > self.im.size[0] - w:  # size is (w, h), check if label fish_weight_estimation beyond right side of image
            ...
            if label:
                ...
                outside = p1[1] >= h  # label fits outside box
                if p1[0] > self.im.shape[1] - w:  # shape is (h, w), check if label fish_weight_estimation beyond right side of image
